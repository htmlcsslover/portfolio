...
export const Hero: React.FC<HeroProps> = React.memo(({ data, canvasRef, heroImageRef, showArrow }) => {
  ...
  return (
    <section id="home" className="relative min-h-screen px-4 pb-12 pt-28 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="mx-auto grid max-w-5xl w-full items-center gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <article className="hero-glass glass-panel reveal relative rounded-2xl p-5 sm:p-6 lg:p-7 flex flex-col justify-between">
          ...
          <div className="action-row glass-panel mt-6 flex w-full flex-wrap items-center justify-evenly gap-4 rounded-xl p-2 sm:gap-6">
            <a
              className="cta-primary magnetic focus-ring"
              href="#contact"
              onClick={(e) => {
                e.preventDefault();
            ...
            <a
              className="cta-secondary magnetic focus-ring"
        ...
        <aside className="reveal relative mx-auto w-full max-w-[18rem] lg:max-w-[18rem]">
          <div className="portrait-shell glass-panel relative mx-auto aspect-[0.92] rounded-2xl p-2">
            <div className="portrait-media">
              {/* Profile image with crop values matching native sizing */}
              <img
                id="hero-image"
                ref={heroImageRef}
                src={isDarkMode ? "/images/darkMode.png" : "/images/lightMode.png"}
                data-light-scale="1.335"
                data-dark-scale="1.335"
                data-light-position="center -25%"
                data-dark-position="center -25%"
              ...
              */}
              <canvas
                ...
                data-frame-light-position="center 15%"
                data-frame-dark-position="center 15%"
