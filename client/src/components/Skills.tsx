    ...
    <section id="skills" className="section-shell px-4 py-7 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        <div className="mb-4 reveal reveal-left">
          ...
          <h2 className="section-title text-neutral-900 dark:text-white">{data.title}</h2>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
          {data.categories.map((category, idx) => (
            ...
            >
              <h3 className="font-title text-lg font-bold text-neutral-900 dark:text-white">{category.name}</h3>
              <ul className="mt-3.5 flex flex-wrap gap-2 text-xs text-neutral-600 dark:text-white/70">
